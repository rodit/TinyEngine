...
namespace TinyEngine.Assets
{
    public class TinyEntity : TinyAsset
    {
        ...
        {
            return TinyEngine.Project.GetConfig("entity/" + Name);
        }
        ...
        public void Load()
        {
            ...
            foreach (XmlAttribute attrib in root.Attributes)
            {
                if (attrib.Name == "class")
                    ...
                    Properties["shop"] = TinyEngine.Project.Shops.Find(x => x.Name == attrib.Value);
    ...
    public class EquipData
    {
        ...
        public void Load(XmlNodeList nl)
        {
            foreach (XmlNode node in nl)
            {
                ...
                TinyItem item = TinyEngine.Project.Items.Find(x => x.Name == itemName);
